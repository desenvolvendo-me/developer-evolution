...
ActiveRecord::Schema[7.0].define(version: 2023_07_15_032931) do
  ...
  create_table "preparations", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "student_id", null: false
    t.index ["student_id"], name: "index_preparations_on_student_id"
  end
  ...
  add_foreign_key "preparations", "students"
