module Intensity
  class Github < BusinessApplication
    ...
    def call
      ...
      if @student.github_commit.to_i >= 1 and github_link_present
        github_intensity = "very_weak"
      end

      if @student.github_commit.to_i >= 2 and github_link_present
        github_intensity = "weak"
      end

      if @student.github_commit.to_i >= 4 and github_link_present
        github_intensity = "medium"
      end

      if @student.github_commit.to_i >= 10 and github_link_present
        github_intensity = "strong"
      end

      if @student.github_commit.to_i > 11 and github_link_present
